...
export default function LoginSpecialistPage() {
  const navigate = useNavigate()
  const [phone, setPhone] = useState('+ 998 ')
  const [agreed, setAgreed] = useState(false)

  return (
    <div className="login-page login-green page-full">
      ...
      <div className="login-content">
        ...
        <h1 className="login-title">Вход для специалистов</h1>
